...
Ce projet sera à réaliser en solo. Le rendu peut se faire soit par un dépôt github (recommandé) soit par une archive (mettre le nom dans le nom du ficiher).
